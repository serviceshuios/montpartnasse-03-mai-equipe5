...
public class SocieteTransportController {
	...
	public String lister(Model model) {
		...
		model.addAttribute("societeTransports", service.findAllSocietes());
		return "societeTransport"; 
	}

	@RequestMapping(value = "/saveSocieteTransport")
	    public String save(SocieteTransport societeTranport,  Model model) {
    ...
    public String edit(@RequestParam int idSociete, Model model) {
        model.addAttribute("societeTransport", service.afficherSocieteTransport(idSociete));
        model.addAttribute("societeTransports", service.findAllSocietes());
        return "societeTransport";
    }
}
